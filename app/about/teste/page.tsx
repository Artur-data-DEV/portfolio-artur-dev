...
import Brain from "@/app/_components/animated/brain";
import { motion, useInView, useScroll } from "framer-motion";
import Image from "next/image";
import { MutableRefObject, useRef } from "react";
import AnimatedNumbers from "@/app/_components/animated/animated-numbers";
...
const AboutPage = () => {
  ...
  const skillRef: MutableRefObject<HTMLDivElement | null> = useRef(null);
  // const isSkillRefInView = useInView(skillRef, {once:true});
  const isSkillRefInView = useInView(skillRef, { margin: "-100px" });

  const experienceRef: MutableRefObject<HTMLDivElement | null> = useRef(null);
  ...
  return (
    <>
      ...
      <div className="flex">
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex h-48 justify-between">
                      ...
                      {/* RIGHT */}
                      <div className="h-full w-1/3 sm:mt-0 md:mt-0 lg:mt-0 xl:mt-0 "></div>
                    </div>
        ...
        <div className="sticky bottom-0 top-0 h-full w-full border border-solid border-black ">
